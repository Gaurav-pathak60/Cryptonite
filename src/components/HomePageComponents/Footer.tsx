...
const Footer = () => {
    return (
        <div><footer className="footer p-10 bg-base-300 text-base-content poppinsFont">
            <div>
                ...
                <a className="link link-hover md:text-lg text-base">API Trading</a>
            </div>
            <div>
                ...
                <a className="link link-hover md:text-lg text-base">Media Assets</a>
            ...
            <div>
                ...
                <a className="link link-hover md:text-lg text-base">Community</a>
          
            </div>
        </footer>
            <footer className="footer px-10 py-4 border-t bg-base-300 text-base-blue border-base-300">
